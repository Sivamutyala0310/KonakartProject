...
public class ConstantFilePaths 
{
	...
	public final static String LOCATORS_FILE = locators_Home + "konakart_locators.properties";


	public final static String testData_Home = homeDir + "src\\test\\resources"+ File.separator + "testdata" + File.separator;
	public final static String TESTDATA_FILE = testData_Home + "konakart_testdata.xlsx";

	public final static String validation_testData = homeDir + "src\\test\\resources" + File.separator + "testdata"
			+ File.separator;
	public final static String ValidationTESTDATA_FILE = validation_testData + "konakartvalidation_testdata.properties";
	
	public final static String validationData_Home = homeDir + "src\\test\\resources"+ File.separator + "testdata" + File.separator;
	public final static String ValidationDATA_FILE = testData_Home + "konakartvalidationdata.xlsx";
